...
"[project]/utils/generale-cv-pdf.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const generateCVPDF = ()=>{
    ...
    // Languages
    addSection("LANGUES", [
        "Malagasy (Natif) • Français (Courant) • Anglais (Intermédiaire)"
    ]);
    // Footer
    doc.setFontSize(8);
    doc.setTextColor(150, 150, 150);
    doc.text("© 2025 MAHASOANIRAINY Jaonarivelo. Tous droits réservés.", 105, 285, {
        align: "center"
    });
    // Download
...
//# sourceMappingURL=utils_generale-cv-pdf_ts_d6f2d98d._.js.map